...
- [#61](https://github.com/kpdecker/jsdiff/pull/61) - Use svg instead of png to get better image quality ([@PranavDaveHello](https://api.github.com/users/PranavDaveHello))
