...
ActionSheetCmp.decorators = [
    { type: Component, args: [{
                ...
                template: '<ion-backdrop (tap)="bdClick()" [class.backdrop-no-tappable]="!d.enableBackdropDismiss"></ion-backdrop>' +
                    ...
                    '<button ion-button="action-sheet-button" (tap)="click(cancelButton)" class="action-sheet-cancel disable-hover" [attr.icon-left]="cancelButton.icon ? \'\' : null" [ngClass]="cancelButton.cssClass">' +
