    ...
    Searchbar.decorators = [
        { type: core_1.Component, args: [{
                    ...
                    template: '<div class="searchbar-input-container">' +
                        '<button ion-button mode="md" (tap)="cancelSearchbar($event)" (mousedown)="cancelSearchbar($event)" clear color="dark" class="searchbar-md-cancel" type="button">' +
                        ...
                        '<button ion-button clear class="searchbar-clear-icon" [mode]="_mode" (tap)="clearInput($event)" (mousedown)="clearInput($event)" type="button"></button>' +
                        '</div>' +
                        '<button ion-button #cancelButton mode="ios" [tabindex]="_isActive ? 1 : -1" clear (tap)="cancelSearchbar($event)" (mousedown)="cancelSearchbar($event)" class="searchbar-ios-cancel" type="button">{{cancelButtonText}}</button>',
                    host: {
