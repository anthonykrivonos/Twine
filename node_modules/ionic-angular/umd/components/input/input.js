...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@angular/core", "@angular/forms", "../app/app", "../../config/config", "../content/content", "../../util/dom", "../../platform/dom-controller", "../../util/form", "../ion", "../../util/util", "../item/item", "./native-input", "./next-input", "../../navigation/nav-controller", "../../platform/platform"], factory);
    }
    ...
    TextInput.decorators = [
        { type: core_1.Component, args: [{
                    ...
                    template: '<input [(ngModel)]="_value" [type]="type" (blur)="inputBlurred($event)" (focus)="inputFocused($event)" [placeholder]="placeholder" [disabled]="disabled" [readonly]="readonly" class="text-input" [ngClass]="\'text-input-\' + _mode" *ngIf="_type!==\'textarea\'"  #input>' +
                        ...
                        '<button ion-button clear [hidden]="!clearInput" type="button" class="text-input-clear-icon" (tap)="clearTextInput()" (mousedown)="clearTextInput()"></button>' +
    ...
    TextInput.propDecorators = {
        ...
        '_nextInput': [{ type: core_1.ViewChild, args: [next_input_1.NextInput,] },],
